      ...
      <div className="relative z-10 w-full  text-white flex items-center justify-center">
        ...
        <div className="home-container h-full w-full mx-4 xl:mx-60 flex-col">
          ...
          <motion.h3
           ...
           <p className="dark:text-black font-semibold text-2xl">I'm Jether Omictin 🤖</p>
           <p className="dark:text-black mb-10">A computer science student from cebu institute of technology - university, philippines.</p>

           <p className="dark:text-black ">I am so interested in the fields of machine learning and artificial intelligence but for now i focused on creating web applications to deliver solutions that empower businesses  and enhance user experiences. I specialize in crafting web apps using <strong>Typescript</strong> and <strong>React</strong>, <strong>NextJS </strong> for user-friendly websites and applications tailored to meet the unique needs of my clients.</p>
            ...
            <div className="education-div py-5">
                  <p className="dark:text-black font-bold text-3xl py-5 ">Education</p>
                  ...
                  <div className="citu  flex px-2 gap-3 ">
                    ...
                    <img className="w-16 h-16 object-contain" src="images/citu_logo.png" alt="" />
                    
                    <div className="text flex flex-col justify-center">
                    <p className="dark:text-black font-semibold ">Cebu Institute of Technology - University</p>
                    <p className="dark:text-black  ">Bachelor of Science in Computer Science</p>
                    </div>
            ...
            <div className="skills-div py-10 text-center flex flex-col items-center justify-center">
              <p className="dark:text-white bg-white text-black font-bold text-xl dark:bg-black p-1 w-28 rounded-lg mb-5">Skills</p>

              <p className="text-white dark:text-black text-lg mb-3">These is the primary <strong>Technologies</strong> i often used</p>
              <div className="tech-stack cursor-pointer hover:scale-105 flex flex-wrap items-center justify-center gap-8 grayscale transition-all duration-500 ease-in-out hover:grayscale-0 p-5">
                {projects.map((item, index) => (
                  <img className="object-contain w-12 h-12" src={item.imgUrl} alt={item.title} key={index} />
                ))}
              </div>
            </div>
